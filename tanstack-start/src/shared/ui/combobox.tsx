...
function ComboboxValue({
  ...
  return (
    <span
      ...
      className={cn('flex-1 min-w-0 truncate text-left overflow-hidden', className)}
    >
...
function ComboboxSelectTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn(
        'border-input focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md border bg-transparent text-sm shadow-xs transition-[color,box-shadow] focus-visible:ring-[3px] aria-invalid:ring-[3px] flex w-full min-w-0 items-center justify-between h-9 gap-1.5 py-2 pr-2 pl-2.5 overflow-hidden outline-none disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
        className,
      )}
      {...props}
    >
...
function ComboboxInput({
  ...
  const hasAddon = showTrigger || showClear
...
function ComboboxListSkeleton({ count = 3 }: ComboboxListSkeletonProps) {
  return (
    <ComboboxList>
...
function ComboboxItem({ className, children, ...props }: ComboboxPrimitive.Item.Props) {
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground gap-2 rounded-sm py-1.5 pr-9 pl-2 text-sm [&_svg:not([class*='size-'])]:size-4 relative flex w-full min-w-0 cursor-default items-center overflow-hidden outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      {...props}
    >
